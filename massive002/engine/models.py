...
import time
from massive002.photologue.models import TagField
...
class OfertaManager(models.Manager):
    def ativa_na_cidade(self, cidade):
        ...
        # Only up to date
        qs = qs.filter(finaliza_em__gte=datetime.datetime.now())
...
class Oferta(models.Model):
    ...
    finaliza_em                = models.DateTimeField(blank=True, null=True, db_index=True)
    ...
    @property
    def quantidade(self):
        return self.qtd_ofertas_por_pessoa
