...
urlpatterns = patterns('',
    ...
    url(r'^contato/$', 'engine.views.contato', name='contatos'),

    # Login/logout
    url(r'^usuario/registrar/$', 'engine.views.registra_usuario', name='user_signup'),
    url(r'^usuario/login/$', 'engine.views.login_usuario', name='login_usuario'),
    url(r'^usario/logout/$', 'engine.views.logout_usuario', name='logout_usuario'),
...
if settings.LOCAL:
    urlpatterns = urlpatterns + patterns('',
        ((r'^media/(?P<path>.*)$', 'django.views.static.serve',
         {'document_root': settings.MEDIA_ROOT})),
        ((r'^geoip/(?P<path>.*)$', 'django.views.static.serve',
         {'document_root': settings.GEOIP_PATH})),
        )
...
urlpatterns = urlpatterns + patterns('',
    url(r'^(?P<cidade_slug>\w+)/$', 'engine.views.cidade_index', name='cidade_index'),
    
    url(r'^(?P<cidade_slug>\w+)/assinar/$', 'engine.views.inscricao_cidade',
        name='city_subscribe'),
                                     
    url(r'^(?P<cidade_slug>\w+)/(?P<oferta_slug>[-\w]+)/$',
        'engine.views.oferta_detalhe', name='oferta_detalhe'),
    ...
    url(r'^(?P<cidade_slug>\w+)/(?P<oferta_slug>[-\w]+)/comprar/$',
        'engine.views.oferta_checkout', name='oferta_checkout'),
